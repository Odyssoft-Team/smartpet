      ...
      try {
        ...
        if (mounted && Array.isArray(data)) {
          const petOrders = data.filter(
            (o) => Number(o.pet_id) === Number(selectedPet.id)
          );
              ...
              <div className="flex justify-between text-xs text-gray-400 mt-1 hidden">
                {[1, 2, 3, 4, 5].map((num) => (
                  <span
                    key={num}
                    className={
                      selectedPet.social_behavior === num
            ...
            {listOrderServices.length > 0 ? (
              ...
              <>
                ...
                <span className="text-sm text-neutral-400 -mt-1 font-light">
                  Aquí podrá visualizar el status de los servicios asociados a
                  esta mascota
                </span>
              </>
            )}
